...
const translations: Record<Lang, Record<string, string>> = {
  bg: {
    ...
    'home.heroBody':
      'От венециански маски до фантазийни същества — открийте перфектния костюм за вашия бал, парти или събитие. Резервирайте на място в нашия магазин.',
    ...
    'seo.homeDesc':
      'Магически костюми под наем в София. Венециански маски, фантазийни образи, Хелоуин и детски костюми. Резервирайте на място.',
    'seo.productsTitle': 'Каталог костюми под наем | CarnivalForYou',
    'seo.productsDesc':
      'Разгледайте наличните костюми под наем — венециански, фантазийни, Хелоуин и детски. Цени на ден, резервация на място в София.',
  },
  en: {
    // nav
    'nav.home': 'Home',
