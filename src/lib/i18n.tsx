...
const translations: Record<Lang, Record<string, string>> = {
  bg: {
    ...
    'common.partOfCouple': 'Част от чифт',
    ...
    'home.popularCostumesTitle': 'Популярни костюми',
    ...
    'products.allKidsCostumes': 'Всички костюми за деца →',
  ...
  en: {
    ...
    'common.partOfCouple': 'Part of a couple set',
    ...
    'home.popularCostumesTitle': 'Popular costumes',
    ...
    'products.allKidsCostumes': 'All kids\' costumes →',
    'products.next': 'Next',
    'products.of': 'of',
