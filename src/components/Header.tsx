      ...
      <div className="site-header-surface glass border-b border-gold-400/15">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 2xl:max-w-[1680px]">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <button
              onClick={openProductFilter}
              className="flex shrink-0 items-center justify-center rounded-full border border-gold-400/30 p-2 text-gold-200 transition hover:border-gold-400/60 hover:bg-gold-400/10 hover:text-gold-100"
              aria-label={t('nav.search')}
              title={t('nav.search')}
            >
              <Search size={18} />
